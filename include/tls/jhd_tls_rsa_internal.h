 ...
 *      - jhd_tls_rsa_deduce_primes
 *      - jhd_tls_rsa_deduce_private_exponent
 *      - jhd_tls_rsa_deduce_crt
 *       Each of these functions takes a set of core RSA parameters and
 *       generates some other, or CRT related parameters.
 *
 *  (2) Parameter-checking helpers. These are:
 *      - jhd_tls_rsa_validate_params
 *      - jhd_tls_rsa_validate_crt
 ...
 *
 */
int jhd_tls_rsa_deduce_primes( jhd_tls_mpi const *N, jhd_tls_mpi const *E,
                               jhd_tls_mpi const *D,
