...
typedef enum {
    ...
    JHD_TLS_KEY_EXCHANGE_DHE_RSA,
    JHD_TLS_KEY_EXCHANGE_ECDHE_RSA,
    JHD_TLS_KEY_EXCHANGE_ECDHE_ECDSA,
    JHD_TLS_KEY_EXCHANGE_PSK,
    JHD_TLS_KEY_EXCHANGE_DHE_PSK,
    JHD_TLS_KEY_EXCHANGE_RSA_PSK,
    JHD_TLS_KEY_EXCHANGE_ECDHE_PSK,
    JHD_TLS_KEY_EXCHANGE_ECDH_RSA,
    JHD_TLS_KEY_EXCHANGE_ECDH_ECDSA,
...
/* Key exchanges involving server signature in ServerKeyExchange */
    ...
    defined(JHD_TLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED)     || \
    defined(JHD_TLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED)
#define JHD_TLS_KEY_EXCHANGE__WITH_SERVER_SIGNATURE__ENABLED
#endif

/* Key exchanges using ECDH */
#if defined(JHD_TLS_KEY_EXCHANGE_ECDH_RSA_ENABLED)      || \
    defined(JHD_TLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED)
#define JHD_TLS_KEY_EXCHANGE__SOME__ECDH_ENABLED
#endif

/* Key exchanges that don't involve ephemeral keys */
#if defined(JHD_TLS_KEY_EXCHANGE_RSA_ENABLED)           || \
    defined(JHD_TLS_KEY_EXCHANGE_PSK_ENABLED)           || \
    defined(JHD_TLS_KEY_EXCHANGE_RSA_PSK_ENABLED)       || \
    defined(JHD_TLS_KEY_EXCHANGE__SOME__ECDH_ENABLED)
...
#define JHD_TLS_KEY_EXCHANGE__SOME_PFS__ENABLED
#endif
...
/* Key exchanges using a PSK */
    ...
    defined(JHD_TLS_KEY_EXCHANGE_DHE_PSK_ENABLED)       || \
    defined(JHD_TLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED)
#define JHD_TLS_KEY_EXCHANGE__SOME__PSK_ENABLED
#endif

/* Key exchanges using DHE */
#if defined(JHD_TLS_KEY_EXCHANGE_DHE_RSA_ENABLED)       || \
    defined(JHD_TLS_KEY_EXCHANGE_DHE_PSK_ENABLED)
#define JHD_TLS_KEY_EXCHANGE__SOME__DHE_ENABLED
#endif
...
/* Key exchanges using ECDHE */
    ...
    defined(JHD_TLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED)   || \
    defined(JHD_TLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED)
#define JHD_TLS_KEY_EXCHANGE__SOME__ECDHE_ENABLED
#endif
...
static inline int jhd_tls_ssl_ciphersuite_uses_ecdh( const jhd_tls_ssl_ciphersuite_t *info )
{
    switch( info->key_exchange )
    {
        case JHD_TLS_KEY_EXCHANGE_ECDH_RSA:
...
static inline int jhd_tls_ssl_ciphersuite_cert_req_allowed( const jhd_tls_ssl_ciphersuite_t *info )
{
    switch( info->key_exchange )
    {
        case JHD_TLS_KEY_EXCHANGE_RSA:
...
static inline int jhd_tls_ssl_ciphersuite_uses_dhe( const jhd_tls_ssl_ciphersuite_t *info )
{
    switch( info->key_exchange )
    {
        case JHD_TLS_KEY_EXCHANGE_DHE_RSA:
