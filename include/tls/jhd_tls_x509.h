...
#else
#define jhd_tls_x509_get_alg_null(p,end,alg) jhd_tls_asn1_get_alg_null( p, end, alg )
#define jhd_tls_x509_get_alg(p,end,alg,params) jhd_tls_asn1_get_alg( p,end, alg, params )
