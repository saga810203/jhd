 ...
 *                      JHD_TLS_ERR_MD_ALLOC_FAILED, or
 *                      JHD_TLS_ERR_HMAC_DRBG_ENTROPY_SOURCE_FAILED.
 */
 ...
 * \param resistance    JHD_TLS_HMAC_DRBG_PR_ON or JHD_TLS_HMAC_DRBG_PR_OFF
 */
 ...
 *                      depends on the hash used, see \c jhd_tls_hmac_drbg_init() )
 *
 * \param ctx           HMAC_DRBG context
 * \param len           Amount of entropy to grab, in bytes
 */
void jhd_tls_hmac_drbg_set_entropy_len( jhd_tls_hmac_drbg_context *ctx,
                                size_t len );

/**
 * \brief               Set the reseed interval
 *                      (Default: JHD_TLS_HMAC_DRBG_RESEED_INTERVAL)
 *
 * \param ctx           HMAC_DRBG context
 * \param interval      Reseed interval
 */
void jhd_tls_hmac_drbg_set_reseed_interval( jhd_tls_hmac_drbg_context *ctx,
                                    int interval );
 ...
 *                      JHD_TLS_ERR_HMAC_DRBG_REQUEST_TOO_BIG, or
 *                      JHD_TLS_ERR_HMAC_DRBG_INPUT_TOO_BIG.
 */
