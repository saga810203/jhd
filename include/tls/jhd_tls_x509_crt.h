 ...
 *                  Default: JHD_TLS_X509_CRT_VERSION_3
 *
 * \param ctx       CRT context to use
 * \param version   version to set (JHD_TLS_X509_CRT_VERSION_1, JHD_TLS_X509_CRT_VERSION_2 or
 *                                  JHD_TLS_X509_CRT_VERSION_3)
 */
 ...
 *                  Requires that jhd_tls_x509write_crt_set_subject_key() has been
 *                  called before
 *
 * \param ctx       CRT context to use
 *
 ...
 *                  Requires that jhd_tls_x509write_crt_set_issuer_key() has been
 *                  called before
 *
 * \param ctx       CRT context to use
 *
 ...
 *                  ECDSA signatures always require a non-NULL f_rng.
 */
int jhd_tls_x509write_crt_pem( jhd_tls_x509write_cert *ctx, unsigned char *buf, size_t size,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng );
