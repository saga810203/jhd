...
#define JHD_LOG_STDERR           	((uint16_t) 1)
#define JHD_LOG_EMERG             	((uint16_t) 2)
#define JHD_LOG_ALERT             	((uint16_t) 3)
#define JHD_LOG_CRIT              	((uint16_t) 4)
#define JHD_LOG_ERR               	((uint16_t) 5)
#define JHD_LOG_WARN              	((uint16_t) 6)
#define JHD_LOG_NOTICE            	((uint16_t) 7)
#define JHD_LOG_INFO              	((uint16_t) 8)
#define JHD_LOG_DEBUG             	((uint16_t) 9)
