...
int jhd_tls_pem_read_buffer_2(unsigned char *buf, size_t *buf_len, const char *header, const char *footer,const unsigned char *data,const unsigned char *pwd,size_t pwdlen, size_t *use_len){
	int ret, enc;
	size_t len;
