...
{
    return( jhd_tls_md2_starts_ret( (jhd_tls_md2_context *) ctx ) );
}

static int md2_update_wrap( void *ctx, const unsigned char *input,
                             size_t ilen )
{
    return( jhd_tls_md2_update_ret( (jhd_tls_md2_context *) ctx, input, ilen ) );
}

static int md2_finish_wrap( void *ctx, unsigned char *output )
{
    return( jhd_tls_md2_finish_ret( (jhd_tls_md2_context *) ctx, output ) );
}

static void *md2_ctx_alloc( void )
{
    void *ctx = jhd_tls_calloc( 1, sizeof( jhd_tls_md2_context ) );

    if( ctx != NULL )
        jhd_tls_md2_init( (jhd_tls_md2_context *) ctx );
...
{
    jhd_tls_md2_free( (jhd_tls_md2_context *) ctx );
    jhd_tls_free( ctx );
}

static void md2_clone_wrap( void *dst, const void *src )
{
    jhd_tls_md2_clone( (jhd_tls_md2_context *) dst,
...
static int md2_process_wrap( void *ctx, const unsigned char *data )
{
    ...
    return( jhd_tls_internal_md2_process( (jhd_tls_md2_context *) ctx ) );
}

const jhd_tls_md_info_t jhd_tls_md2_info = {
    JHD_TLS_MD_MD2,
    "MD2",
    16,
    16,
...
{
    return( jhd_tls_md4_starts_ret( (jhd_tls_md4_context *) ctx ) );
}

static int md4_update_wrap( void *ctx, const unsigned char *input,
                             size_t ilen )
{
    return( jhd_tls_md4_update_ret( (jhd_tls_md4_context *) ctx, input, ilen ) );
}

static int md4_finish_wrap( void *ctx, unsigned char *output )
{
    return( jhd_tls_md4_finish_ret( (jhd_tls_md4_context *) ctx, output ) );
}

static void *md4_ctx_alloc( void )
{
    void *ctx = jhd_tls_calloc( 1, sizeof( jhd_tls_md4_context ) );

    if( ctx != NULL )
        jhd_tls_md4_init( (jhd_tls_md4_context *) ctx );
...
{
    jhd_tls_md4_free( (jhd_tls_md4_context *) ctx );
    jhd_tls_free( ctx );
}

static void md4_clone_wrap( void *dst, const void *src )
{
    jhd_tls_md4_clone( (jhd_tls_md4_context *) dst,
                       (const jhd_tls_md4_context *) src );
}

static int md4_process_wrap( void *ctx, const unsigned char *data )
{
    return( jhd_tls_internal_md4_process( (jhd_tls_md4_context *) ctx, data ) );
}

const jhd_tls_md_info_t jhd_tls_md4_info = {
    JHD_TLS_MD_MD4,
    "MD4",
    16,
    64,
...
{
    void *ctx = jhd_tls_calloc( 1, sizeof( jhd_tls_md5_context ) );
